...
//#region VALIDAR INFO DEL CLIENTE 
...
confirmClienteData(){
  ...
  if (errors == 0 && formatErrors == 0) {
    ToastUtils.showSuccessToast('Datos del cliente guardados!')
  }else if (errors != 0) {
...
//#region VALIDAR COMPRA DEL TICKET
  ...
  selectClassicTicket(index: number): void {
    ...
    console.log(this.selectedClassicTicket);
  }
  ...
  selectVIPTicket(index: number): void {
    ...
    console.log(this.selectedVIPTicket);
  }
